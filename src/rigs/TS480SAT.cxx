...
bool RIG_TS480SAT::sendTScommand(string cmd, int retnbr, bool loghex)
{
...
void RIG_TS480SAT::set_mode(int val)
{
	mode_ = val;
	cmd = "MD";
...
void RIG_TS480SAT::set_bandwidth(int val)
{
	bw_ = val;
...
int RIG_TS480SAT::get_bandwidth()
{
	cmd = "SL;";
...
void RIG_TS480SAT::set_power_control(double val)
{
	cmd = "PC";
	char szval[4];
	if (mode_ == 4 && val > 25) val = 25; // AM mode limitation
