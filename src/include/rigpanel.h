...
#define mnuTooltips (menu_+4)
#define mnuColorConfig (menu_+5)
#define mnuConfigXcvr (menu_+6)
#define mnuStore (menu_+8)
#define mnuStored (menu_+9)
#define mnuHelp (menu_+12)
#define mnuAbout (menu_+13)
#define mnuEventLog (menu_+14)
...
extern Fl_Spinner *cnt_line_out;
extern Fl_ComboBox *cbo_agc_level;
extern Fl_Spinner *cnt_cw_wpm;
extern Fl_Spinner *cnt_cw_vol;
extern Fl_Spinner *cnt_cw_spot;
extern Fl_Spinner *cnt_vox_gain;
extern Fl_Spinner *cnt_anti_vox;
extern Fl_Spinner *cnt_vox_hang;
extern Fl_Light_Button *btn_vox;
extern Fl_Spinner *cnt_compression;
