...
unsigned long long RIG_FT990::get_vfoA ()
{
	return A.freq;
}

void RIG_FT990::set_vfoA (unsigned long long freq)
{
...
unsigned long long RIG_FT990::get_vfoB()
{
	return B.freq;
}

void RIG_FT990::set_vfoB(unsigned long long freq)
{
	int current_vfo = inuse;
