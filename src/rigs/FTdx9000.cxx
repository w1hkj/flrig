...
void RIG_FTdx9000::set_band_selection(int v)
{
	int inc_60m = false;
	cmd = "IF;";
...
void RIG_FTdx9000::set_vfoA (long freq)
{
	freqA = freq;
	cmd = "FA00000000;";
	for (int i = 9; i > 1; i--) {
...
void RIG_FTdx9000::set_vfoB (long freq)
{
	freqB = freq;
	cmd = "FB00000000;";
	for (int i = 9; i > 1; i--) {
...
int RIG_FTdx9000::def_bandwidth(int val)
{
	return FTdx9000_def_bw[val];
}
...
int RIG_FTdx9000::get_noise()
{
	...
	size_t p = replystr.rfind(rsp);
	if (p == string::npos) return FTdx9000_blanker_level;
