...
#ifdef IC7100_DEBUG
	stringstream ss2;
	ss2 << " (" << val << ") [" << IC7100modes_[val] << "] " <<
	str2hex(cmd.data(), cmd.length());
	LOG_INFO("%s", ss2.str().c_str());
#endif
	waitFB("set/clear digital");
}
