...
unsigned long int RIG_FTdx1200::get_vfoA ()
{
	cmd = "FA;";
	rsp = "FA";
...
void RIG_FTdx1200::set_vfoA (unsigned long int freq)
{
	freqA = freq;
	cmd = "FA00000000;";
	for (int i = 9; i > 1; i--) {
...
unsigned long int RIG_FTdx1200::get_vfoB ()
{
	cmd = "FB;";
	rsp = "FB";
...
void RIG_FTdx1200::set_vfoB (unsigned long int freq)
{
	freqB = freq;
	cmd = "FB00000000;";
	for (int i = 9; i > 1; i--) {
