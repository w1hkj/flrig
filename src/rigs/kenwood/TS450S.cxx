...
unsigned long long RIG_TS450S::get_vfoA ()
{
	cmd = "FA;";
...
void RIG_TS450S::set_vfoA (unsigned long long freq)
{
	freqA = freq;
	cmd = "FA00000000000;";
	for (int i = 12; i > 1; i--) {
...
unsigned long long RIG_TS450S::get_vfoB ()
{
	cmd = "FB;";
...
void RIG_TS450S::set_vfoB (unsigned long long freq)
{
	freqB = freq;
	cmd = "FB00000000000;";
	for (int i = 12; i > 1; i--) {
